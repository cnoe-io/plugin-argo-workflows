...
export class IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateLintRequest {
    ...
    static getAttributeTypeMap() {
        return IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateLintRequest.attributeTypeMap;
    }
